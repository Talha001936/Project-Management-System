      ...
      <CardContent sx={{ p: 2.5 }}>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", mb: 1.5 }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, overflow: "hidden" }}>
            <Typography
              variant="h6"
              fontWeight={600}
              sx={{ color: "#e8e8e8", fontSize: "1.1rem", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}
            >
              {project.name}
            </Typography>
            {roleBadge && (
              <Chip
                ...
                size="small"
                sx={{
                  backgroundColor: roleBadge === "Manager" 
                    ? "rgba(240,160,48,0.12)" 
                    : "rgba(108,99,255,0.12)",
                  color: roleBadge === "Manager" ? "#f0a030" : "#6c63ff",
                  border: roleBadge === "Manager" 
        ...
        <Button
          ...
          sx={{
            ...
            borderRadius: 1.5,
            py: 0.8,
            "&:hover": { borderColor: "#6c63ff", backgroundColor: "rgba(108,99,255,0.06)" },
            textTransform: "none",
            fontWeight: 500,
          }}
        >
