// Note: This component is responsible for managing teams, including displaying a list of teams,
// searching, creating, editing, and deleting teams. It handles user permissions and displays appropriate
  ...
  return (
    <Box>
      ...
      {!filteredTeams.length ? (
        <EmptyState
          message={
            searchTerm ? "No teams match your search." :
            user.role === "employee"
                        ...
                        {members.map((m) => (
                          <Chip
                            ...
                            sx={{
                              ...
                              color:
                                Number(m.id) === Number(team.leaderId) ? "#6c63ff" : "#888888",
                              border:
                                Number(m.id) === Number(team.leaderId)
